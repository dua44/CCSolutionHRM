...
namespace CCSolutionHRM.DAL
{
    public class CCSolutionInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<CCSolutionContext>
    {
        protected override void Seed(CCSolutionContext context)
        {
            ...
            {
            new Company{Address="",CreationBy=1,CreationDate=DateTime.Now,CreationIP="127.0.0.1",DialingCode=971,EmailAddress="",Name="CCSolution",PhoneNumber=""
            ,UpdationBy=1,UpdationDate=DateTime.Now,UpdationIP="127.0.0.1",Url="",Deleted=false}
            };
            ...
            {
            new Document{CreationBy=1, CreationDate = DateTime.Now, CreationIP="127.0.0.1",Delete=false,Name="NIC",UpdationBy=1, UpdationDate=DateTime.Now, UpdationIP="127.0.0.1"},
            new Document{CreationBy=1, CreationDate = DateTime.Now, CreationIP="127.0.0.1",Delete=false,Name="PassPort",UpdationBy=1, UpdationDate=DateTime.Now, UpdationIP="127.0.0.1"},
            new Document{CreationBy=1, CreationDate = DateTime.Now, CreationIP="127.0.0.1",Delete=false,Name="Visa",UpdationBy=1, UpdationDate=DateTime.Now, UpdationIP="127.0.0.1"},
            new Document{CreationBy=1, CreationDate = DateTime.Now, CreationIP="127.0.0.1",Delete=false,Name="Education",UpdationBy=1, UpdationDate=DateTime.Now, UpdationIP="127.0.0.1"}
            };
            ...
            {
            new Employee{EmailAddress="dua2004@gmail.com",CompanyId=1,CreationBy=1,CreationDate=DateTime.Now,CreationIP="127.0.0.1",CurrentAddress="",DateOfBirth=DateTime.Now.AddYears(-36),Delete=false,DialingCode1=92,DialingCode2=92,GenderId=1,
            Name="Muhammad Rizwan",NationalityId=1,PermenantAddress="",PhoneNumber1="3222999643",PhoneNumber2="3222999643",UpdationBy=1,UpdationDate=DateTime.Now,UpdationIP="127.0.0.1"},
            new Employee{EmailAddress="sabir@gmail.com",CompanyId=1,CreationBy=1,CreationDate=DateTime.Now,CreationIP="127.0.0.1",CurrentAddress="",DateOfBirth=DateTime.Now.AddYears(-36),Delete=false,DialingCode1=92,DialingCode2=92,GenderId=1,
            Name="Muhammad Sabir",NationalityId=1,PermenantAddress="",PhoneNumber1="3222999665",PhoneNumber2="3222999665",UpdationBy=1,UpdationDate=DateTime.Now,UpdationIP="127.0.0.1"}
            };
